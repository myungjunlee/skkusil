...
import { update } from '../actions/apost';
...
const Edit_found = ({ read, update, isAuthenticated, list }) => {
    ...
    // submit 후의 read함수 발동과 page 이동 관련
    ...
    const { id, user, lost_found, title, campus, building, latitude, longitude, address, location, date, item, color, content } = postData;
    ...
    const onSubmit = e => {
        ...
        //  submit 클릭하면 update함수 호출되면서 list 값 바뀌고 이 함수 발동
        useEffect(() => {
            // 초기 발동 억제
            if (!skip) {
                setSkip(true);
    ...
    // 게시물 수정했을 시 상세 페이지로
    if (postUpdated) {
        return <Redirect to = '/detail_found'/>
    }
    ...
    const page1 = () => (
        <div>
            <div className="NL-new_exp" id='pg1'>
                <h2>카테고리 선택</h2>
                <p>카테고리에 맞게 습득물을 등록하고, <br /> 비슷한 분실물이 올라오면 알림으로 받아보세요!</p>
            </div>
            <div className="NL-new_category">
                <div className="NL-campus">
                    <div className="NL-new_theme">습득 캠퍼스</div>
                    <div className="NL-new_sel">
                        <select 
                ...
                <div className="NL-campus">
                    <div className="NL-new_theme">습득 건물</div>
                    <div className="NL-new_sel">
                        <select 
                            className="NL-campus_opt" 
                            name='building' 
                ...
                <div className="NL-campus">
                    <div className="NL-new_theme">습득 일자</div>
                    <div className="NL-new_sel">
                        <input
                            type='date'
                            name='date'
    ...
    const page2 = () => (
        <div>
            <div className="NL-new_exp" id='pg2'>
                <h2>상세정보 입력</h2>
                <p>분실자가 습득물을 더 쉽게 찾아드릴 수 있도록 <br/> 상세 설명이나 사진 등을 추가해주세요!</p>
            </div>
...
export default connect(mapStateToProps, { read, update })(Edit_found);