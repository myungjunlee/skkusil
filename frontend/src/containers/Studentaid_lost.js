...
const Studentaid_lost = () => {

    const [linkSL, setLinkSL] = useState(false);

    useEffect(() => {
        document.body.className='SAL-body';
    });
    
    const individualLost = (e) => {
        e.preventDefault();
        setLinkSL(true);
    };
    ...
    return (
        <div>
            ...
            <div className="SAL-search_option">
                <button type="button" className="SAL-Indi_btn" onClick={e => individualLost(e)}>개인분실물</button>
...
export default Studentaid_lost;