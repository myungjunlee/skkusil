...
import { read, create } from '../actions/post';
...
const New_found = ({ read, create, isAuthenticated, _user }) => {
    ...
    const mapButtonPop = () => (
        <div>
            <div className="NL-campus">
                <div className="NL-new_theme">습득 위치</div>
    ...
    const page2 = () => (
        <div>
            <div className="NL-new_exp" id='pg2'>
                <h2>상세정보 입력</h2>
                <p>분실자가 분실물을 더 쉽게 찾아드릴 수 있도록 <br/> 상세 설명이나 사진 등을 추가해주세요!</p>
            </div>
...
export default connect(mapStateToProps, { read, create })(New_found);